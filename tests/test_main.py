...
class TestAudioIO:
    ...
    def test_read_write_wav_roundtrip(self):
...
class TestBinauralGeneration:
    ...
    def test_generate_binaural_wav_duration(self):
    ...
    def test_generate_binaural_wav_bit_depth(self):
    ...
    def test_generate_binaural_wav_stereo_enforcement(self):
...
class TestMixing:
    ...
    def test_mix_binaural_and_ambience_length(self):
    ...
    def test_mix_mono_ambience_duplication(self):
    ...
    def test_mix_samplerate_guard(self):
    ...
    def test_mix_clipping_guard(self):
