...
class TestListVibes:
    ...
    def test_list_vibes_with_presets_and_aliases(self, mock_print, mock_aliases, mock_presets):
        ...
        mock_presets.items.return_value = [("calm", mock_preset1), ("deep", mock_preset2)]

        # Mock aliases
        mock_aliases.items.return_value = [("sleep", "deep"), ("night", "calm")]
...
class TestMainFunctionality:
    ...
    @patch("sys.exit")
    def test_main_subcommand_with_list_vibes(
        self,
        mock_exit,
        mock_list_vibes,
        mock_setup_logging,
    ...
    @patch("sleepstack.cli.setup_logging")
    @patch("sys.exit")
    def test_main_subcommand_with_func(
        self,
        mock_exit,
        mock_setup_logging,
        mock_cleanup,
    ...
    @patch("sys.exit")
    def test_main_subcommand_keyboard_interrupt(
        self,
        mock_exit,
        mock_logging,
        mock_setup_logging,
    ...
    @patch("sleepstack.cli.logging")
    @patch("sys.exit")
    def test_main_subcommand_exception_verbose(
        self,
        mock_exit,
        mock_logging,
        mock_setup_logging,
    ...
    @patch("sleepstack.cli.logging")
    @patch("sys.exit")
    def test_main_subcommand_exception_not_verbose(
        self,
        mock_exit,
        mock_logging,
        mock_setup_logging,
    ...
    @patch("sys.exit")
    def test_main_backward_compatibility_with_list_vibes(
        self,
        mock_exit,
        mock_run,
        mock_list_vibes,
        ...
        with patch("sleepstack.cli.argparse.ArgumentParser") as mock_global_parser:
            ...
            mock_global_parser_instance.parse_known_args.return_value = (
                mock_global_args,
                ["--vibe", "calm"],
            )
    ...
    @patch("sleepstack.cli.run")
    @patch("sys.exit")
    def test_main_backward_compatibility_with_run(
        self,
        mock_exit,
        mock_run,
        mock_setup_logging,
    ...
    @patch("sleepstack.cli.logging")
    @patch("sys.exit")
    def test_main_backward_compatibility_keyboard_interrupt(
        self,
        mock_exit,
        mock_logging,
        mock_setup_logging,
    ...
    @patch("sleepstack.cli.logging")
    @patch("sys.exit")
    def test_main_backward_compatibility_exception_verbose(
        self,
        mock_exit,
        mock_logging,
        mock_setup_logging,
    ...
    @patch("sleepstack.cli.logging")
    @patch("sys.exit")
    def test_main_backward_compatibility_exception_not_verbose(
        self,
        mock_exit,
        mock_logging,
        mock_setup_logging,
    ...
    @patch("sleepstack.cli.add_repair_assets_parser")
    @patch("sleepstack.cli.add_cleanup_assets_parser")
    def test_main_backward_compatibility_system_exit(
        self,
        mock_cleanup,
        mock_repair,
        mock_validate,
