...
class TestDownloadAmbientCommand:
    ...
    def test_download_ambient_success(
        self, mock_download, mock_get_ambient_manager, mock_get_asset_manager
    ):
        ...
        assert result == 0
        mock_download.assert_called_once_with(url="https://example.com", sound_name="test_sound")
        ...
        mock_asset_manager.create_individual_metadata_file.assert_called_once_with(
            "test_sound", mock_metadata
        )

    @patch("sleepstack.commands.download_ambient.get_asset_manager")
    @patch("sleepstack.commands.download_ambient.get_ambient_manager")
    @patch("sleepstack.commands.download_ambient.download_and_process_ambient_sound")
    def test_download_ambient_success_no_description(
        self, mock_download, mock_get_ambient_manager, mock_get_asset_manager
    ):
    ...
    @patch("sleepstack.commands.download_ambient.get_ambient_manager")
    @patch("sleepstack.commands.download_ambient.download_and_process_ambient_sound")
    def test_download_ambient_success_no_metadata(
        self, mock_download, mock_get_ambient_manager, mock_get_asset_manager
    ):
    ...
    @patch("sleepstack.commands.download_ambient.get_ambient_manager")
    @patch("sleepstack.commands.download_ambient.download_and_process_ambient_sound")
    def test_download_ambient_update_metadata_with_url(
        self, mock_download, mock_get_ambient_manager, mock_get_asset_manager
    ):
    ...
    @patch("sleepstack.commands.download_ambient.get_ambient_manager")
    @patch("sleepstack.commands.download_ambient.download_and_process_ambient_sound")
    def test_download_ambient_no_url_provided(
        self, mock_download, mock_get_ambient_manager, mock_get_asset_manager
    ):
...
class TestAddDownloadAmbientParser:
    ...
    def test_parser_arguments(self):
        ...
        args = parser.parse_args(["download-ambient", "https://example.com", "test_sound"])
        assert args.url == "https://example.com"
        assert args.name == "test_sound"
...
class TestIntegration:
    ...
    def test_download_with_invalid_url(self, mock_download):
        ...
        assert result == 1
        mock_download.assert_called_once_with(url="invalid_url", sound_name="test_sound")
    ...
    def test_download_with_invalid_sound_name(self, mock_download):
        ...
        assert result == 1
        mock_download.assert_called_once_with(url="https://example.com", sound_name="invalid/name")
