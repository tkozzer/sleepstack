...
def main():
    ...
    p.add_argument("--carrier", type=float, default=200.0, help="Carrier frequency in Hz (e.g., 180–300)")
    p.add_argument("--samplerate", type=int, default=48000, help="Sample rate (e.g., 44100 or 48000)")
    ...
    print(f"Wrote {args.out} — {duration:.1f}s @ {args.samplerate} Hz | beat={args.beat} Hz, carrier={args.carrier} Hz")
